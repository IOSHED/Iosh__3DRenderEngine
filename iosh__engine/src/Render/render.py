...
from Render.Camera.camera import Camera
from Render.Matrix_functions.projection_matrix import Projection
from Render.Object.object_engine import *
from Window.window import Window
from settings import POSITION_CAMERA_X, POSITION_CAMERA_Y, POSITION_CAMERA_Z, BG_COLOR_R, BG_COLOR_G, BG_COLOR_B, \
